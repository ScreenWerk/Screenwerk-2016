...
3.1. Download (https://git-scm.com/download/win) and install `Git-****.exe` (In the install dialogue, remove checkbox mark from the __"Enable GIT Credential Manager")__ 
3.2. Install `node-****.msi` from `installers` folder
